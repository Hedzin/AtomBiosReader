...
public class ATOM_POWERPLAY_VCE_STATE_TABLE_V7_1 extends ADynamicContainer {
	ATOM_POWERPLAY_HEADER ppHeader =  new ATOM_POWERPLAY_HEADER();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject1 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject2 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject3 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject4 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject5 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject6 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject7 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
	ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1 ppVceStateObject8 =  new ATOM_POWERPLAY_VCE_STATE_OBJECT_V7_1();
